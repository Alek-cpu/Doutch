...
if (!class_exists('AMWSCP_PFeedOverride')) {
    class AMWSCP_PFeedOverride extends AMWSCP_PBaseFeedOverride
    {
            ...
            foreach ($this->advancedCommands as $this_option) {
                ...
                switch ($command) {
                    ...
                    case 'map':
                        ...
                        if (isset($params[1])) {
                            foreach ($parent->attributeMappings as $thisMapping) {
                                if ($params[3] == $thisMapping->mapTo) {
                                    $attr_value = $params[1];
                                    $thisMapping->attributeName = $attr_value;
                                    break;
                                }
                            }
                        }
                    ...
                    case 'setattribute':
                        if (strtolower($params[2]) == 'mapto') {
                            if ($parent->getMapping($params[1]) != null) {
                                ...
                                $recent_attribute->mapTo = $attr_value;
                            }
                        }
                        if (strtolower($params[2]) == 'default') {
                            if (isset($params[4]))
                                ...
                                $defaultClass = 'AMWSCP_PAttributeDefault';
                    ...
                    case 'setrapidcarttoken':
                        global $amwcore;
                        $amwcore->settingSet('cp_rapidcarttoken', $params[1]);
                        break;
