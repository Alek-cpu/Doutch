...
if (!class_exists('AMWSCP_PBaseFeedOverride')){
    class AMWSCP_PBaseFeedOverride {
        ...
        protected function loadDropDownMappings($providerName) {
            global $amwcore;
            $loadDropDownMappings = 'loadDropDownMappings' . $amwcore->callSuffix;
        ...
        protected function loadAdvancedCommands($providerName) {
            global $amwcore;
            $loadAdvancedCommands = 'loadAdvancedCommands' . $amwcore->callSuffix;
        ...
        private function loadAdvancedCommandsW($providerName) {
            //Advanced options
            $this->advancedCommands = explode("\n", get_option($providerName . '-amwscp-settings'));
        }
