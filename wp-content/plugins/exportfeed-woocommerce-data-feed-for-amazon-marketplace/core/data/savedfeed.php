...
if (!class_exists('AMWSCPF_SavedFeed')) {
    class AMWSCPF_SavedFeed
    {

        function __construct($id)
        {
            global $amwcore;
            $feedLoader = 'feedLoader' . $amwcore->callSuffix;
            $this->$feedLoader($id);
        }
        ...
        private function feedLoaderW($id)
        {
            ...
            $this->category_id = $feed_details->category;
            $this->remote_category = $feed_details->remote_category;
            $this->amazon_category = $feed_details->amazon_category;
            $this->filename = $feed_details->filename;
            $this->url = $feed_details->url;
            $this->own_overrides = $feed_details->own_overrides;
            $this->feed_overrides = $feed_details->feed_overrides;
            if(property_exists($feed_details, 'verified'))
              $this->verified = $feed_details->verified;
            ...
            // calling feed_type
            $remote_category = $feed_details->remote_category;
            $this->feed_product_type = $feed_details->feed_product_type;
            $this->recommended_browse_nodes = $feed_details->recommended_browse_nodes;
            $this->item_type_keyword = $feed_details->item_type_keyword;
            $this->variation_theme = $feed_details->variation_theme;
        }
        ...
        {
            global $amwcore;
            $feedOverrideSaver = 'feedOverrideSaver' . $amwcore->callSuffix;
