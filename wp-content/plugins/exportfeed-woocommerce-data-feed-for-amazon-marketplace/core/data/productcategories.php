...
if (!class_exists('AMWSCP_PProductCategories')) {
    class AMWSCP_PProductCategories
    {
        ...
        {
            global $amwcore;
            $getListCall = 'getList' . $amwcore->callSuffix;
        ...
        public function getListJS()
        {
			...
			WHERE (shop_id = ' . (int)$amwcore->shopID . ') AND (state = 1)
		');
            $this->categories = $db->loadObjectList();
