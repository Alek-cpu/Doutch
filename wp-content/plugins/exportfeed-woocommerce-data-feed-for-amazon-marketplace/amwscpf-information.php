...
function amwscpf_print_info()
{
    ...
    if (($day2 == $today) && ($lic_validation == 'Invalid') ){
        echo '<div class="update-nag" id="report_msg" style="display: block"><p>Start a free trial to create the feed. <a href="http://www.exportfeed.com/" target="_blank">Contact us</a> for more details.</p></div>';
    }
    ...
    $steps = ['Connect to Amazon Marketplace','Set a Default Account','Create Amazon Product Feed'];
    ...
    foreach ($steps as $key => $step){
        ...
        if ($key == 0){
            if (!$amazon->check_if_any_account_is_created() > 0){
                ...
                $step_1_message = "Connect to Amazon Marketplace";
            } else {
                ...
                $step_1_message = "Connected to Amazon Marketplace";
        ...
        if ($key == 1){
            if (!$amazon->check_if_any_account_is_created(true) > 0){
                ...
                $step_2_message = "Set Default Account";
            } else {
                $tip = 'Safe to proceed next step.';
                $span = '<span class="dashicons dashicons-yes"></span>';
                $s1 = true;
                $step_2_message = "Default Account Set";
            }
        }
        // if ($key == 2 ){
        //     if (! $no_of_template > 0){
        ...
        if ($key == 2 ){
            if(!$amazon->checkifFeedisGenerated()){
                $class = '';
                ...
                $step_3_message = "Ready to create Feed";
            }else{
                $step_3_message = "All setup Done";
            }
        ...
        echo
            ...
            <section>
              ...
              <div class="progress-bar-horizonatal green">
                <div class="step active">
                  <div class="step-circle"><span>1</span></div>
                  <div class="step-title">'.$step_1_message.'</div>
                  <div class="step-bar-left"></div>
                  <div class="step-bar-right"></div>
                </div>
                <div class="step active">
                  <div class="step-circle"><span>2</span></div>
                  <div class="step-title">'.$step_2_message.'</div>
                  <div class="step-bar-left"></div>
                  <div class="step-bar-right"></div>
                </div>
                <div class="step active">
                  <div class="step-circle"><span>3</span></div>
                  <div class="step-title">'.$step_3_message.'</div>
                  <div class="step-bar-left"></div>
                  <div class="step-bar-right"></div>
                </div>
