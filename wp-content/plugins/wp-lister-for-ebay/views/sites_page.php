...
<div class="wrap">
	...
	<h2><?php echo __( 'WP-Lister Network Sites', 'wp-lister-for-ebay' ) ?></h2>
	...
	<form method="post" action="<?php echo $wpl_form_action; ?>">
		<div class="submit" style="padding-top: 0; float: left;">
			...
			<input type="submit" value="<?php echo __( 'Update sites', 'wp-lister-for-ebay' ) ?>" name="submit" class="button"
				   title="<?php echo __( 'Update recent sites from eBay.', 'wp-lister-for-ebay' ) ?>">
		</div>
	</form>
	-->
