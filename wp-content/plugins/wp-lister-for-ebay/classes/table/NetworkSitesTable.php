...
class NetworkSitesTable extends WP_List_Table {
    ...
    function column_blog_title($item){
        ...
        //Build row actions
        $actions = array(
            'dashboard'  => sprintf('<a href="%s/wp-admin/">%s</a>', $blog_details->siteurl, __( 'Dashboard', 'wp-lister-for-ebay' ) ),
            'settings'   => sprintf('<a href="%s/wp-admin/admin.php?page=wplister-settings">%s</a>', $blog_details->siteurl, __( 'Settings', 'wp-lister-for-ebay' ) ),
            // 'reinstall'  => sprintf('<a href="?page=%s&action=%s&site=%s">%s</a>',$page,'reinstall',$item['blog_id'],__( 'Re-Install', 'wp-lister-for-ebay' )),
            'install'    => sprintf('<a href="?page=%s&action=%s&site=%s">%s</a>',$page,'install',$item['blog_id'],__( 'Install', 'wp-lister-for-ebay' )),
            'uninstall'  => sprintf('<a href="?page=%s&action=%s&site=%s">%s</a>',$page,'uninstall',$item['blog_id'],__( 'Uninstall', 'wp-lister-for-ebay' )),
            'activate'   => sprintf('<a href="?page=%s&action=%s&site=%s">%s</a>',$page,'activate',$item['blog_id'],__( 'Activate', 'wp-lister-for-ebay' )),
            'deactivate' => sprintf('<a href="?page=%s&action=%s&site=%s">%s</a>',$page,'deactivate',$item['blog_id'],__( 'Deactivate', 'wp-lister-for-ebay' )),
            // 'edit'      => sprintf('<a href="?page=%s&action=%s&site=%s">%s</a>',$page,'edit',$item['blog_id'],__( 'Edit', 'wp-lister-for-ebay' )),
        );
    ...
    function column_status($item){
        ...
        switch( $this->blog->enabled ){
            case 'Y':
                $color = 'darkgreen';
                $value = __( 'enabled', 'wp-lister-for-ebay' );
                break;
            case 'N':
                $color = 'darkred';
                $value = __( 'disabled', 'wp-lister-for-ebay' );
                break;
            default:
                $color = 'gray';
                $value = __( 'not installed', 'wp-lister-for-ebay' );
        }
    ...
    function get_columns(){
        $columns = array(
            ...
            // 'blog_id'        => __( 'Site ID', 'wp-lister-for-ebay' ),
            'blog_title'        => __( 'Title', 'wp-lister-for-ebay' ),
            'status'            => __( 'Status', 'wp-lister-for-ebay' ),
            'ebay_id'           => __( 'eBay ID', 'wp-lister-for-ebay' ),
            'db_version'        => __( 'DB Version', 'wp-lister-for-ebay' ),
            'setup_step'        => __( 'Setup', 'wp-lister-for-ebay' ),
            'tpl_dir'           => __( 'Folder', 'wp-lister-for-ebay' ),
    ...
    function get_bulk_actions() {
        $actions = array(
            'activate'     => __( 'Activate', 'wp-lister-for-ebay' ),
            'deactivate'   => __( 'Deactivate', 'wp-lister-for-ebay' ),
            'update_db'    => __( 'Update DB', 'wp-lister-for-ebay' ),
