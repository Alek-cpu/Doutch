 ...
 * @property \Inpsyde\Lib\PayPal\Api\Currency refund_to_payer
 * @property \Inpsyde\Lib\PayPal\Api\ExternalFunding[] refund_to_external_funding
 * @property \Inpsyde\Lib\PayPal\Api\Currency refund_from_transaction_fee
 * @property \Inpsyde\Lib\PayPal\Api\Currency refund_from_received_amount
 * @property \Inpsyde\Lib\PayPal\Api\Currency total_refunded_amount
 */
class DetailedRefund extends Refund
{
     ...
     *
     * @param \Inpsyde\Lib\PayPal\Api\Currency $refund_to_payer
     * 
     * @return $this
     */
     ...
     *
     * @param \Inpsyde\Lib\PayPal\Api\ExternalFunding[] $refund_to_external_funding
     * 
     * @return $this
     */
     ...
     *
     * @param \Inpsyde\Lib\PayPal\Api\Currency $refund_from_transaction_fee
     * 
     * @return $this
     */
     ...
     *
     * @param \Inpsyde\Lib\PayPal\Api\Currency $refund_from_received_amount
     * 
     * @return $this
     */
     ...
     *
     * @param \Inpsyde\Lib\PayPal\Api\Currency $total_refunded_amount
     * 
     * @return $this
     */
