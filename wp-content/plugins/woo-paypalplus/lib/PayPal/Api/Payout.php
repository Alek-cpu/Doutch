 ...
 *
 * @property \Inpsyde\Lib\PayPal\Api\PayoutSenderBatchHeader sender_batch_header
 * @property \Inpsyde\Lib\PayPal\Api\PayoutItem[] items
...
class Payout extends PayPalResourceModel
{
     ...
     *
     * @param \Inpsyde\Lib\PayPal\Api\PayoutSenderBatchHeader $sender_batch_header
     *
     * @return $this
     */
     ...
     * The original batch header as provided by the payment sender.
     *
     * @return \Inpsyde\Lib\PayPal\Api\PayoutSenderBatchHeader
     */
     ...
     *
     * @param \Inpsyde\Lib\PayPal\Api\PayoutItem[] $items
     *
     * @return $this
     */
     ...
     * An array of payout items (that is, a set of individual payouts).
     *
     * @return \Inpsyde\Lib\PayPal\Api\PayoutItem[]
     */
     ...
     *
     * @param \Inpsyde\Lib\PayPal\Api\PayoutItem $payoutItem
     * @return $this
     */
