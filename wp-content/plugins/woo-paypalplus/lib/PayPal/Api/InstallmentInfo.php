 ...
 * @property \Inpsyde\Lib\PayPal\Api\InstallmentOption[] installment_options
 */
class InstallmentInfo extends PayPalModel
{
     ...
     *
     * @param \Inpsyde\Lib\PayPal\Api\InstallmentOption[] $installment_options
     * 
     * @return $this
     */
     ...
     * List of available installment options and the cost associated with each one.
     *
     * @return \Inpsyde\Lib\PayPal\Api\InstallmentOption[]
     */
     ...
     *
     * @param \Inpsyde\Lib\PayPal\Api\InstallmentOption $installmentOption
     * @return $this
     */
