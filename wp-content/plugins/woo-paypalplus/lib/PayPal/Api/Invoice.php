 ...
 * @property \Inpsyde\Lib\PayPal\Api\MerchantInfo merchant_info
 * @property \Inpsyde\Lib\PayPal\Api\BillingInfo[] billing_info
 * @property \Inpsyde\Lib\PayPal\Api\Participant[] cc_info
 * @property \Inpsyde\Lib\PayPal\Api\ShippingInfo shipping_info
 * @property \Inpsyde\Lib\PayPal\Api\InvoiceItem[] items
 * @property string invoice_date
 * @property \Inpsyde\Lib\PayPal\Api\PaymentTerm payment_term
 * @property string reference
 * @property \Inpsyde\Lib\PayPal\Api\Cost discount
 * @property \Inpsyde\Lib\PayPal\Api\ShippingCost shipping_cost
 * @property \Inpsyde\Lib\PayPal\Api\CustomAmount custom
 * @property bool allow_partial_payment
 * @property \Inpsyde\Lib\PayPal\Api\Currency minimum_amount_due
 ...
 * @property \Inpsyde\Lib\PayPal\Api\Currency total_amount
 * @property \Inpsyde\Lib\PayPal\Api\PaymentDetail[] payments
 * @property \Inpsyde\Lib\PayPal\Api\RefundDetail[] refunds
 * @property \Inpsyde\Lib\PayPal\Api\Metadata metadata
 * @property \Inpsyde\Lib\PayPal\Api\PaymentSummary paid_amount
 * @property \Inpsyde\Lib\PayPal\Api\PaymentSummary refunded_amount
 * @property \Inpsyde\Lib\PayPal\Api\FileAttachment[] attachments
 */
class Invoice extends PayPalResourceModel
{
     ...
     *
     * @param \Inpsyde\Lib\PayPal\Api\MerchantInfo $merchant_info
     * 
     * @return $this
     */
     ...
     * Information about the merchant who is sending the invoice.
     *
     * @return \Inpsyde\Lib\PayPal\Api\MerchantInfo
     */
     ...
     *
     * @param \Inpsyde\Lib\PayPal\Api\BillingInfo[] $billing_info
     * 
     * @return $this
     */
     ...
     * The required invoice recipient email address and any optional billing information. One recipient is supported.
     *
     * @return \Inpsyde\Lib\PayPal\Api\BillingInfo[]
     */
     ...
     *
     * @param \Inpsyde\Lib\PayPal\Api\BillingInfo $billingInfo
     * @return $this
     */
     ...
     *
     * @param \Inpsyde\Lib\PayPal\Api\Participant[] $cc_info
     * 
     * @return $this
     */
     ...
     * For invoices sent by email, one or more email addresses to which to send a Cc: copy of the notification. Supports only email addresses under participant.
     *
     * @return \Inpsyde\Lib\PayPal\Api\Participant[]
     */
     ...
     *
     * @param \Inpsyde\Lib\PayPal\Api\Participant $participant
     * @return $this
     */
     ...
     *
     * @param \Inpsyde\Lib\PayPal\Api\ShippingInfo $shipping_info
     * 
     * @return $this
     */
     ...
     * The shipping information for entities to whom items are being shipped.
     *
     * @return \Inpsyde\Lib\PayPal\Api\ShippingInfo
     */
     ...
     *
     * @param \Inpsyde\Lib\PayPal\Api\InvoiceItem[] $items
     * 
     * @return $this
     */
     ...
     * The list of items to include in the invoice. Maximum value is 100 items per invoice.
     *
     * @return \Inpsyde\Lib\PayPal\Api\InvoiceItem[]
     */
     ...
     *
     * @param \Inpsyde\Lib\PayPal\Api\InvoiceItem $invoiceItem
     * @return $this
     */
     ...
     *
     * @param \Inpsyde\Lib\PayPal\Api\PaymentTerm $payment_term
     * 
     * @return $this
     */
     ...
     * Optional. The payment deadline for the invoice. Value is either `term_type` or `due_date` but not both.
     *
     * @return \Inpsyde\Lib\PayPal\Api\PaymentTerm
     */
     ...
     *
     * @param \Inpsyde\Lib\PayPal\Api\Cost $discount
     * 
     * @return $this
     */
     ...
     * The invoice level discount, as a percent or an amount value.
     *
     * @return \Inpsyde\Lib\PayPal\Api\Cost
     */
     ...
     *
     * @param \Inpsyde\Lib\PayPal\Api\ShippingCost $shipping_cost
     * 
     * @return $this
     */
     ...
     * The shipping cost, as a percent or an amount value.
     *
     * @return \Inpsyde\Lib\PayPal\Api\ShippingCost
     */
     ...
     *
     * @param \Inpsyde\Lib\PayPal\Api\CustomAmount $custom
     * 
     * @return $this
     */
     ...
     * The custom amount to apply on an invoice. If you include a label, the amount cannot be empty.
     *
     * @return \Inpsyde\Lib\PayPal\Api\CustomAmount
     */
     ...
     *
     * @param \Inpsyde\Lib\PayPal\Api\Currency $minimum_amount_due
     * 
     * @return $this
     */
     ...
     *
     * @param \Inpsyde\Lib\PayPal\Api\Currency $total_amount
     * 
     * @return $this
     */
     ...
     *
     * @param \Inpsyde\Lib\PayPal\Api\PaymentDetail[] $payments
     * 
     * @return $this
     */
     ...
     * List of payment details for the invoice.
     *
     * @return \Inpsyde\Lib\PayPal\Api\PaymentDetail[]
     */
     ...
     *
     * @param \Inpsyde\Lib\PayPal\Api\PaymentDetail $paymentDetail
     * @return $this
     */
     ...
     *
     * @param \Inpsyde\Lib\PayPal\Api\RefundDetail[] $refunds
     * 
     * @return $this
     */
     ...
     * List of refund details for the invoice.
     *
     * @return \Inpsyde\Lib\PayPal\Api\RefundDetail[]
     */
     ...
     *
     * @param \Inpsyde\Lib\PayPal\Api\RefundDetail $refundDetail
     * @return $this
     */
     ...
     *
     * @param \Inpsyde\Lib\PayPal\Api\Metadata $metadata
     * 
     * @return $this
     */
     ...
     * Audit information for the invoice.
     *
     * @return \Inpsyde\Lib\PayPal\Api\Metadata
     */
     ...
     *
     * @param \Inpsyde\Lib\PayPal\Api\PaymentSummary $paid_amount
     * 
     * @return $this
     */
     ...
     * Payment summary of the invoice including amount paid through PayPal and other sources.
     *
     * @return \Inpsyde\Lib\PayPal\Api\PaymentSummary
     */
     ...
     *
     * @param \Inpsyde\Lib\PayPal\Api\PaymentSummary $refunded_amount
     * 
     * @return $this
     */
     ...
     *
     * @param \Inpsyde\Lib\PayPal\Api\FileAttachment[] $attachments
     * 
     * @return $this
     */
     ...
     * List of files attached to the invoice.
     *
     * @return \Inpsyde\Lib\PayPal\Api\FileAttachment[]
     */
     ...
     *
     * @param \Inpsyde\Lib\PayPal\Api\FileAttachment $fileAttachment
     * @return $this
     */
